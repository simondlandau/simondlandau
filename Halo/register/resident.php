...
$_SESSION['resid']=$password;
$_SESSION['user']=true;
$sql="SELECT * FROM Residents WHERE FirstName='$username' and Res_ID='$password';"; 
...
$ret= mysqli_query($con,"SELECT * FROM Residents WHERE FirstName='$username' and Res_ID='$password';");
...
$_SESSION['id']=$num['ID'];
 ...
 header("location:/Stepwork/Res_Apply.php");
exit();
}
else
{
...
<body>
<div class="main">
		<h7>Please Login to Manage Step Work.</h7>
