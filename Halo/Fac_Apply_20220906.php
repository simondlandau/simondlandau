...
<link rel="stylesheet" href="/Jahara/css4/bootstrap.min.css">
...
<script src="/enquiryadapt/popper.min.js"></script>
<script src="/Jahara/js/bootstrap.min.js"></script>
<script>
		$(function() {
...
<li class="nav-item active"><a class="nav-link text-white active" href="/Halo/Fac_Apply.php?function=capture">Capture Image 📸 </a></li>
	...
	<li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarMedical">
          <a class="dropdown-item" href="Fac_Apply.php?function=display">Medication <i class="fas fa-columns" style="color:green;"></i></a>
...
Hi <?php echo $login .". "?>Thank you for managing the Camp database online. Please select a Menu option</font> 
	...
	<p>
<!--<?php 
	if ($function !== "display" and $function !== "capture"):
?>
